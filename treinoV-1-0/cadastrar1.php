<html>
    ...
    <body>
        ...
        <?php
            ...
            //inserindo dados
            $sqlinsert = "insert into carros (Codigo, Marca, Modelo, Fabricante, Tipo, Ano, Combustivel, Cor, Chassi, km, imagem)
            values ('$Codigo', '$Marca', '$Modelo', '$Fabricante', '$Tipo', '$Ano', '$Combustivel', '$Cor', '$Chassi', '$km', '$imagem')";
